...
def create_visit_checkout(
    ...
    """Create a Stripe Checkout session for a one-time visit payment with split payout"""
    ...
    # Configuration for split payment (Destination Charge)
    checkout_params = {
        "payment_method_types": ["card"],
        "line_items": [{
            "price_data": {
                ...
                "product_data": {
                    ...
                    "description": "Pago por visita técnica (incluye comisión plataforma)",
                },
    ...
    if stripe_account_id:
        checkout_params["transfer_data"] = {
            "destination": stripe_account_id,
            "amount": technician_payment,
        }
