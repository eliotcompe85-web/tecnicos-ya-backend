...
from config import SECRET_KEY, ALGORITHM, ACCESS_TOKEN_EXPIRE_MINUTES, BACKEND_URL
...
async def send_verification_email(email: str, full_name: str, token: str) -> None:
    ...
    logger.info(f"Verificación simulada: enviar correo a {email} con enlace {verification_url}")
